...
//ToDo Array nur mit einem besetzt wenn bild dann besetzt wird in PhotoScreen wird ein neues element hinzugefügt 
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([storyItemsRow valueForKey:@"imageWithText"]){
        ...
        [storyCell.imageView setContentMode:UIViewContentModeScaleToFill];

...
- (IBAction)takePhoto:(id)sender {
    ...
    /*
    CGRect overlayViewRect = CGRectMake(0, 0, imagePicker.view.frame.size.width, imagePicker.view.frame.size.height);
    UIView *overlayView = [[UIView alloc] initWithFrame:overlayViewRect];
    CGRect overlayRect = CGRectMake(0, 0,_photo.frame.size.width, _photo.frame.size.height);
    UIView* overlay = [[UIView alloc] initWithFrame:overlayRect];
    overlay.center = overlayView.center;
    overlay.alpha = 0.5;
...
-(void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    UIImage *resizedImage = [croppedImage resizedImage:CGSizeMake(_photo.frame.size.width, _photo.frame.size.height) imageOrientation:originalImage.imageOrientation];

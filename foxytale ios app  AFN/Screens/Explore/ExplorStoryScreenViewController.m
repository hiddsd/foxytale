...
- (void)viewDidLoad
{
    ...
    storyId = [storyItem objectForKey:@"IdStory"];
    likes = [storyItem objectForKey:@"likes"];

    
    self.storyDescription.text = [storyItem objectForKey:@"description"];
    self.likeCountLabel.text = [NSString stringWithFormat:@"%@", likes];
    
    int contributercount = (int)[[storyItem objectForKey:@"contributercount"] integerValue];
    self.contributersCountLabel.text = [NSString stringWithFormat:@"%d",contributercount + 1];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *storyItem = _storyItems[_pageIndex * 4 + indexPath.row];
    
    //load the photos
    int IdUser = [[storyItem objectForKey:@"IdUser"] intValue];
    int IdStory = [[storyItem objectForKey:@"IdStory"] intValue];
    int IdPhoto = [[storyItem objectForKey:@"IdPhoto"] intValue];
    ...
    [storyCell.imageView setImageWithURL:imageURL];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    explorPhotoScreenViewController.cellIndex = indexPath.row;
